    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/" className={"flex flex-row gap-2 items-center"}>
          ...
          <h1 className={"text-3xl text-[#F8F7F4] font-semibold"}>Tsingy</h1>
        </NavLink>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  <img src={Overview} className="h-5 w-5"  alt={"overview"}/>
                  Overview
                </NavLink>
              </li>
              ...
              <li>
                <NavLink
                  to="/feedback"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === '/feedback' && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
              ...
              {/* <!-- Menu Item Nature --> */}
              <SidebarLinkGroup activeCondition={pathname.includes('species')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
